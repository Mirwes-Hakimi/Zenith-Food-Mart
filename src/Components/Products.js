...
function Products(){
    ...
    return (
        ...
        <ul className="items">
          ...
          <img src={process.env.PUBLIC_URL + "/images/Jalibee1.jpg"} alt="img" />
          </li>
          ...
          <img src={process.env.PUBLIC_URL + "/images/afghanibrade2.jpg"} alt="img"/>
          </li>
          ...
          <img src={process.env.PUBLIC_URL + "/images/creams.jpg"} alt="img" />
          </li>
          ...
          <img src={process.env.PUBLIC_URL + "/images/kitchen.jpg"} alt="img"/>
          </li>
        </ul>
        </div>
